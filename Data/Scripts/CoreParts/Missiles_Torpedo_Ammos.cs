...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Missiles_Torpedo
        {
            get
            {
                var he = new HighExplosive(450.0f);
                return new AmmoDef
                {
        ...
        private AmmoDef Missiles_Torpedo_NPC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Missiles_Torpedo", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Missiles_Torpedo_NPC", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 3600, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                AccelPerSec = 25f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
                DesiredSpeed = 300, // voxel phasing if you go above 5100
                MaxTrajectory = 4000f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 15), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "MD_MissileThrustFlame", // Please always have this Line set, if this Section is enabled.
                        },
