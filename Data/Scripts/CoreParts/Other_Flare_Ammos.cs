...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef SmokescreenWC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "FlareClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Smokescreen", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Smokescreen_Fragment", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef // Note AOE is only applied to the Player/Grid it hit (and nearby projectiles) not nearby grids/players.
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "MD_Smokescreen", // Particle SubtypeID, from your Particle SBC
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "MD_Smokescreen", //ShipWelderArc
                        Offset = Vector(x: 0, y: 0, z: 0),
                        DisableCameraCulling = false,// If not true will not cull when not in view of camera, be careful with this and only use if you know you need it
                        Extras = new ParticleOptionDef
                        {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f, //
                        Width = 0.1f, //
                        Color = Color(red: 0.01f, green: 0.01f, blue: 0.01f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        AlwaysDraw = false, // Prevents this tracer from being culled.  Only use if you have a reason too (very long tracers/trails).
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0.01f, green: 0.01f, blue: 0.01f, alpha: 1),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = false,
        ...
        private AmmoDef SmokescreenWC_Fragment => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "FlareClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Smokescreen_Fragment", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 100000f, // Direct damage; one steel plate is worth 100.
            Mass = 50f, // In kilograms; how much force the impact will apply to the target.
            Health = 100000000, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    ...
                    Particle = new ParticleDef // Particle effect to generate at the field's position.
                    {
                        Name = "MD_Smokescreen", // SubtypeId of field particle effect. ShipWelderArc
                        Extras = new ParticleOptionDef
                        {
                            Scale = 1, // Scale of effect.
                        },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 0.5f, //
                        Color = Color(red: 10f, green: 0f, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        AlwaysDraw = false, // Prevents this tracer from being culled.  Only use if you have a reason too (very long tracers/trails).
