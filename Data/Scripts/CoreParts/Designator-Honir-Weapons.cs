...
namespace Scripts {   
    partial class Parts {
        ...
        // Code reworked for CoreSystems by Starwm042
        WeaponDefinition honir_designator_01_def => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "honir_designator_01",
                        ...
                        IconName = "honir_designator_01.png" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
                },
                Muzzles = new[] {
                    "muzzle_missile_1",
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = Parts.MaxRadarRange, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "LRD-100 Designator HONIR", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
