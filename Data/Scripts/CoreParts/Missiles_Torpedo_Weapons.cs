    ...
    partial class Parts
    {
        WeaponDefinition Torpedo_Crusader_Large => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = MaxLongMissileRange, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
        ...
        WeaponDefinition Torpedo_Crusader_Small => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTargetDistance = MaxLongMissileRange, // 0 = unlimited, Maximum target distance that targets will be automatically shot at.
                MinTargetDistance = 500, // 0 = unlimited, Min target distance that targets will be automatically shot at.
                TopTargets = 1, // 0 = unlimited, max number of top targets to randomize between.
                TopBlocks = 1, // 0 = unlimited, max number of blocks to randomize between
                StopTrackingSpeed = 1000, // do not track target threats traveling faster than this speed
            },
            HardPoint = new HardPointDef
            {
                ...
                Other = new OtherDef
                {
                    ...
                    MuzzleCheck = false,
                    Debug = false,
                    RestrictionRadius = 0.0f, // Meters, radius of sphere disable this gun if another is present
